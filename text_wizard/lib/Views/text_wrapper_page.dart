...
import '../Cubit/TextWrapper/text_wrapper_cubit.dart';
import '../Cubit/TextWrapper/text_wrapper_state.dart';

class TextWrapperPage extends StatelessWidget {
  const TextWrapperPage({super.key});
    ...
    return BlocConsumer<TextWrapperCubit, TextWrapperState>(
      listener: (context, state) {
        if (state is TextWrapperOptionChange) {
          cubit.outputTextController.text = cubit.textWrapper();
        }
      },
      builder: (context, state) {
        ...
        cubit.suffixTextController.addListener(() {
          cubit.outputTextController.text = cubit.textWrapper();
        });
        return Scaffold(
          ...
          body: GestureDetector(
            ...
            child: CustomScrollView(
              slivers: [
                // 1 AppBar
                customAppbar(context: context, title: "Text Wrapper"),

...
import '../Cubit/WordWrapper/word_wrapper_cubit.dart';
import '../Cubit/WordWrapper/word_wrapper_state.dart';

class WordWrapperPage extends StatelessWidget {
  const WordWrapperPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<WordWrapperCubit, WordWrapperState>(
      listener: (context, state) {},
      builder: (context, state) {
        final cubit = WordWrapperCubit.getCubit(context);
        ...
        return Scaffold(
          ...
          body: GestureDetector(
            ...
            child: CustomScrollView(
              slivers: [
                // 1 AppBar
                customAppbar(context: context, title: "Word Wrapper"),

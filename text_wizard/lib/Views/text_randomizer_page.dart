...
import '../Cubit/TextRandomizer/text_randomizer_cubit.dart';
import '../Cubit/TextRandomizer/text_randomizer_state.dart';

class TextRandomizerPage extends StatelessWidget {
  const TextRandomizerPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<TextRandomizerCubit, TextRandomizerState>(
      listener: (context, state) {
        if (state is TextRandomizerOptionChange) {
          outputTextController.text = cubit.textRandomizer(
        ...
        return Scaffold(
          ...
          body: GestureDetector(
            ...
            child: CustomScrollView(
              slivers: [
                // 1 AppBar
                customAppbar(context: context, title: "Text Randomizer"),

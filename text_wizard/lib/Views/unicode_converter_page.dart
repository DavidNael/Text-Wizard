...
import '../Cubit/UnicodeConverter/unicode_converter_cubit.dart';
import '../Cubit/UnicodeConverter/unicode_converter_state.dart';

class UnicodeConverterPage extends StatelessWidget {
  const UnicodeConverterPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<UnicodeConverterCubit, UnicodeConverterState>(
      listener: (context, state) {},
      builder: (context, state) {
        final cubit = UnicodeConverterCubit.getCubit(context);
        ...
        return Scaffold(
          ...
          body: GestureDetector(
            ...
            child: CustomScrollView(
              slivers: [
                // 1 AppBar
                customAppbar(context: context, title: "Unicode Converter"),

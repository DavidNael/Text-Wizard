...
import '../Cubit/TextSuffixer/text_suffixer_cubit.dart';
import '../Cubit/TextSuffixer/text_suffixer_state.dart';

class TextSuffixerPage extends StatelessWidget {
  const TextSuffixerPage({super.key});

  @override
  Widget build(BuildContext context) {
    final cubit = TextSuffixerCubit.getCubit(context);
    return BlocConsumer<TextSuffixerCubit, TextSuffixerState>(
      listener: (context, state) {
        if (state is TextSuffixerOptionChange) {
          cubit.outputTextController.text = cubit.textSuffixer();
        }
      },
